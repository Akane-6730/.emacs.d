...
% =========================================
% Font selection for XeLaTeX/LuaLaTeX
\usepackage{fontspec}
...
% Minted style for gray boxed code blocks
...
% Define theorem environments (English)
\newtcbtheorem[number within=section]{definition}{Definition}{lalustyle={red}}{def}
\newtcbtheorem[number within=section]{theorem}{Theorem}{lalustyle={violet}}{thm}
\newtcbtheorem[number within=section]{example}{Example}{lalustyle={blue}}{ex}
...
\begin{tcblaluthmbox}{{\bfseries Proof}}{#1}{#2}
	}{
